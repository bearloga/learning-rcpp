...
```{Rcpp cerealization, ref.label = c('myclass_definition', 'myclass_test', 'myclass_serialization', 'myclass_deserialization'), cache = TRUE, include = FALSE}
```
...
```{Rcpp serialized_nbc, eval = FALSE}
// [[Rcpp::plugins(mlpack11)]]
// [[Rcpp::depends(RcppArmadillo)]]
