...
```{Rcpp kmeans_source, cache = TRUE, dependson = 'mlpack11'}
...
```{Rcpp nbc_source, dependson = 'mlpack11', cache = TRUE}
// [[Rcpp::plugins(mlpack11)]]
// [[Rcpp::depends(RcppArmadillo)]]
...
```{Rcpp nb_train_source, dependson = 'mlpack11', cache = TRUE}
// [[Rcpp::plugins(mlpack11)]]
// [[Rcpp::depends(RcppArmadillo)]]
...
```{Rcpp nb_classify_source, dependson = c('mlpack11', 'nb_train_source'), cache = TRUE}
// [[Rcpp::plugins(mlpack11)]]
// [[Rcpp::depends(RcppArmadillo)]]
